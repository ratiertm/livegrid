defmodule LiveviewGridWeb.Layouts do
  ...
  defp sidebar_icon(%{name: "builder"} = assigns) do
    ~H"""
    <svg class={icon_class(@active)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 4v16m8-8H4M7 7h10a2 2 0 012 2v6a2 2 0 01-2 2H7a2 2 0 01-2-2V9a2 2 0 012-2z" />
    </svg>
    """
  end
